...
{
    #region DTOClasses
    public class UserEditableSettingsMapper : SimpleCRUDFluentTableMap.TableMapper<UserEditableSettings>
    {
    ...
    public class UserMapper : SimpleCRUDFluentTableMap.TableMapper<User>
    {
            public UserMapper()
            {
                ToTableName("Users");
    ...
    public class User1Mapper : SimpleCRUDFluentTableMap.TableMapper<User1>
    {
            public User1Mapper()
            {
                ToTableName("Users");
    ...
    public class CarMapper : SimpleCRUDFluentTableMap.TableMapper<Car>
    {
            public CarMapper()
            {
                Map(c => c.CarId).AsKey();
    ...
    public class BigCarMapper : SimpleCRUDFluentTableMap.TableMapper<BigCar>
    {
            public BigCarMapper()
            {
                Map(c => c.CarId).AsKey();
    ...
    public class CarLogMapper : SimpleCRUDFluentTableMap.TableMapper<CarLog>
    {
            public CarLogMapper()
            {
    ...
    /// </summary>
    public class SchemalessCarLogMapper : SimpleCRUDFluentTableMap.TableMapper<SchemalessCarLog>
    {
    ...
    public class CityMapper : SimpleCRUDFluentTableMap.TableMapper<City>
    {
            public CityMapper()
            {
                Map(c => c.Name).AsKey();
    ...
    public class CityWithINameMapper : SimpleCRUDFluentTableMap.TableMapper<CityWithIName>
    {
    ...
    public class UserWithINameMapper : SimpleCRUDFluentTableMap.TableMapper<UserWithIName>
    {
    ...
    public class GUIDTestMapper : SimpleCRUDFluentTableMap.TableMapper<GUIDTest>
    {
    ...
    public class StringTestMapper : SimpleCRUDFluentTableMap.TableMapper<StringTest>
    {
    ...
    public class StrangeColumnNamesMapper : SimpleCRUDFluentTableMap.TableMapper<StrangeColumnNames>
    {
    ...
    public class IgnoreColumnsMapper : SimpleCRUDFluentTableMap.TableMapper<IgnoreColumns>
    {
    ...
    public class UserWithoutAutoIdentityMapper : SimpleCRUDFluentTableMap.TableMapper<UserWithoutAutoIdentity>
    {
    ...
    public class KeyMasterMapper : SimpleCRUDFluentTableMap.TableMapper<KeyMaster>
    {
