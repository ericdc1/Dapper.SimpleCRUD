    ...
    class Program
    {
        ...
        private static void SetupDB2()
        {
            ...
            using (var connection = new DB2Connection(string.Format("Server={0};UID={1};PWD={2};Database={3};", "localhost:50000", user, user, "testdb")))
            {
                ...
                connection.Execute(@"create table Users (Id int not null generated by default as identity, Name varchar(100) not null, Age int not null, ScheduledDayOff int null, CreatedDate date not null default current_date, primary key(Id));");
                connection.Execute(@"create table Car (CarId int not null generated by default as identity, Id int null, Make varchar(100) not null, Model varchar(100) not null, primary key(CarId));");
                ...
                connection.Execute(@"create table ""dbo"".""GUIDTest""(""Id"" varchar(38) not null, ""name"" varchar(50) not null, primary key(""Id""));");
                ...
                connection.Execute(@"create table GradingScale (""ScaleID"" int not null generated by default as identity, ""AppID"" int, ""ScaleName"" varchar(50) not null, ""IsDefault"" smallint not null);");
