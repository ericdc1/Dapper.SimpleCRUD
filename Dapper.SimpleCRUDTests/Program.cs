    ...
    class Program
    {
        ...
        private static void Setup()
        {
            ...
            using (var connection = new SqlConnection(@"Data Source = (LocalDB)\v11.0;Initial Catalog=DapperSimpleCrudTestDb;Integrated Security=True"))
            {
                ...
                connection.Execute(@" CREATE TABLE AutogeneratedClass ([ID] [int] NOT NULL, [Name] [nvarchar](50) NOT NULL, CONSTRAINT [PK_AutogeneratedClass] PRIMARY KEY CLUSTERED ([Id] ASC))");
            }
        ...
        private static void SetupSqLite()
        {
            ...
            using (connection)
            {
                ...
                connection.Execute(@" CREATE TABLE AutogeneratedClass (ID INTEGER PRIMARY KEY, Name nvarchar(50) NOT NULL)");
            }
        }
