	...
	class Program
	{
		...
		private static void Setup()
		{
			...
			using (var connection = new SqlConnection(@"Data Source = (LocalDB)\v11.0;Initial Catalog=DapperSimpleCrudTestDb;Integrated Security=True"))
			{
				...
				connection.Execute(@" CREATE TABLE CompositePK ([CompositePK1ID] [int] NOT NULL, [CompositePK2ID] [int] NOT NULL, [Description] [nvarchar](50) NOT NULL,
									 CONSTRAINT [PK_CompositePK] PRIMARY KEY CLUSTERED 
									(
										[CompositePK1ID] ASC,
										[CompositePK2ID] ASC
									))");
		...
		private static void SetupSqLite()
		{
			...
			using (connection)
			{
				...
				connection.Execute(@" CREATE TABLE CompositePK ([CompositePK1ID] [int] NOT NULL, [CompositePK2ID] [int] NOT NULL, [Description] [nvarchar](50) NOT NULL,
									 CONSTRAINT [PK_CompositePK] PRIMARY KEY 
									(
										[CompositePK1ID] ASC,
										[CompositePK2ID] ASC
									))");
