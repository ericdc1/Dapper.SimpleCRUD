    ...
    class Program
    {
        ...
        private static void SetupDB2()
        {
            ...
            using (var connection = new DB2Connection(string.Format("Server={0};UID={1};PWD={2};Database={3};", "localhost:50000", user, user, "testdb")))
            {
                ...
                // DB2 database object name default is upper case, else is case sensitive.
                // Use the alias for pase the delete test.
                ...
                connection.Execute(@"create alias strangecolumnnames for ""StrangeColumnNames""");
                ...
                connection.Execute(@"create alias userwithoutautoidentity for ""UserWithoutAutoIdentity""");
                ...
                connection.Execute(@"create alias ignorecolumns for ""IgnoreColumns""");
                ...
                connection.Execute(@"create alias keymaster for ""KeyMaster""");
            }
        }
