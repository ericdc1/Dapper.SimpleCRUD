...
namespace Dapper
{
    ...
    public static partial class SimpleCRUD
    {
        ...
        /// <param name="commandTimeout"></param>
        /// <returns>Returns a count of records.</returns>
        public static async Task<int> RecordCountAsync<T>(this IDbConnection connection, object whereConditions, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var currenttype = typeof(T);
            var name = GetTableName(currenttype);
            ...
            var query = await connection.QueryAsync<int>(sb.ToString(), whereConditions, transaction, commandTimeout);
            return query.Single();
        }
    }
}
