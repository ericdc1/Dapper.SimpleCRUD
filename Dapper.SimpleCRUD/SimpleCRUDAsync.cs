...
namespace Dapper
{
    ...
    public static partial class SimpleCRUD
    {
        ...
        public static async Task<T> GetAsync<T>(this IDbConnection connection, object id, List<string> searchFields = null, IDbTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        public static Task<IEnumerable<T>> GetListAsync<T>(this IDbConnection connection, object whereConditions, List<string> searchFields = null, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var currenttype = typeof(T);
            var idProps = GetIdProperties(currenttype).ToList();
        ...
        public static Task<IEnumerable<T>> GetListAsync<T>(this IDbConnection connection, string conditions, object parameters = null, List<string> searchFields = null, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var currenttype = typeof(T);
            var idProps = GetIdProperties(currenttype).ToList();
            if (!idProps.Any())
        ...
        public static Task<IEnumerable<T>> GetListAsync<T>(this IDbConnection connection, List<string> searchFields = null)
        {
            return connection.GetListAsync<T>(new { }, searchFields);
        }
        ...
        public static Task<IEnumerable<T>> GetListPagedAsync<T>(this IDbConnection connection, int pageNumber, int rowsPerPage, string conditions, string orderby, object parameters = null, List<string> searchFields = null, IDbTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        public static Task<int?> InsertAsync<TEntity>(this IDbConnection connection, TEntity entityToInsert, List<string> insertFields = null, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            return InsertAsync<int?, TEntity>(connection, entityToInsert, insertFields, transaction, commandTimeout);
        }

        /// <summary>
        /// <para>Inserts multiple rows into the database asynchronously</para>
        /// <para>By default inserts into the table matching the class name</para>
        /// <para>-Table name can be overridden by adding an attribute on your class [Table("YourTableName")]</para>
        /// <para>Insert filters out Id column and any columns with the [Key] attribute</para>
        /// <para>Properties marked with attribute [Editable(false)] and complex types are ignored</para>
        ...
        public static Task<int> InsertBatchAsync<TEntity>(this IDbConnection connection, List<TEntity> entityToInserts, List<string> insertFields = null, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            if (entityToInserts.Count == 0) return Task.FromResult(0);
            ...
            return connection.ExecuteAsync(sb.ToString(), entityToInserts, transaction, commandTimeout);
        }

        /// <summary>
        /// <para>Inserts a row into the database asynchronously, using ONLY the properties defined by TEntity</para>
        /// <para>By default inserts into the table matching the class name</para>
        /// <para>-Table name can be overridden by adding an attribute on your class [Table("YourTableName")]</para>
        /// <para>Insert filters out Id column and any columns with the [Key] attribute</para>
        /// <para>Properties marked with attribute [Editable(false)] and complex types are ignored</para>
        ...
        public static async Task<TKey> InsertAsync<TKey, TEntity>(this IDbConnection connection, TEntity entityToInsert, List<string> insertFields = null, IDbTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        /// <param name="commandTimeout"></param>
        /// <returns>The number of affected records</returns>
        public static Task<int> UpdateAsync<TEntity>(this IDbConnection connection, TEntity entityToUpdate, List<string> updateFields = null, IDbTransaction transaction = null, int? commandTimeout = null, System.Threading.CancellationToken? token = null)
        {
        ...
        /// <summary>
        /// <para>Updates multiple records in the database with only the properties of TEntity asynchronously</para>
        /// <para>By default updates records in the table matching the class name</para>
        /// <para>-Table name can be overridden by adding an attribute on your class [Table("YourTableName")]</para>
        /// <para>Updates records where the Id property and properties with the [Key] attribute match those in the database.</para>
        /// <para>Properties marked with attribute [Editable(false)] and complex types are ignored</para>
        ...
        /// <param name="commandTimeout"></param>
        /// <returns>The number of affected records</returns>
        public static Task<int> UpdateBatchAsync<TEntity>(this IDbConnection connection, List<TEntity> entityToUpdates, List<string> updateFields = null, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            if (entityToUpdates.Count == 0) return Task.FromResult(0);
            ...
            return connection.ExecuteAsync(masterSb.ToString(), entityToUpdates, transaction, commandTimeout);
        }
        ...
        /// <summary>
        /// <para>Deletes a list of records in the database asynchronously</para>
        /// <para>By default deletes records in the table matching the class name</para>
        /// <para>-Table name can be overridden by adding an attribute on your class [Table("YourTableName")]</para>
