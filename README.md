...
Check out the [T4 template](https://github.com/ericdc1/Dapper.SimpleCRUD/blob/master/SampleWebsite/Models/ModelGenerator.tt) to generate your POCOs. Documentation is at https://github.com/ericdc1/Dapper.SimpleCRUD/wiki/T4-Template
