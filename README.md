...
Features
--------
Dapper.SimpleCRUD is a [single file](https://github.com/ericdc1/dapper-dot-net/blob/master/Dapper.SimpleCRUD/SimpleCRUD.cs) you can drop in to your project that will extend your IDbConnection interface.
