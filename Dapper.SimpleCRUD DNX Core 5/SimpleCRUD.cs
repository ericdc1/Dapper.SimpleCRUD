...
namespace Dapper
{
    ...
    public static partial class SimpleCRUD
    {
        ...
        private static string GetTableName(Type type)
        {
            ...
            var tableattr = (TableAttribute)System.Reflection.CustomAttributeExtensions.GetCustomAttribute(type.GetTypeInfo(), typeof(TableAttribute), true);
...
internal static class TypeExtension
{
    ...
    public static bool IsSimpleType(this Type type)
    {
        ...
        return simpleTypes.Contains(type) || Dapper.TypeExtensions.IsEnum(type);
    }
}
