...
namespace Dapper
{
    ...
    public static partial class SimpleCRUD
    {
        ...
        public static IEnumerable<T> GetList<T>(this DbConnection connection, string conditions, object parameters = null, DbTransaction transaction = null, int? commandTimeout = null)
        {
            var currenttype = typeof(T);
            var idProps = GetIdProperties(currenttype).ToList();
            if (!idProps.Any())
        ...
        public static IEnumerable<T> GetListPaged<T>(this DbConnection connection, int pageNumber, int rowsPerPage, string conditions, string orderby, object parameters = null, DbTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        /// <param name="commandTimeout"></param>
        /// <returns>The number of records effected</returns>
        public static int DeleteList<T>(this DbConnection connection, object whereConditions, DbTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        public static int RecordCount<T>(this DbConnection connection, string conditions = "", object parameters = null, DbTransaction transaction = null, int? commandTimeout = null)
        {
            var currenttype = typeof(T);
            var name = GetTableName(currenttype);
            var sb = new StringBuilder();
